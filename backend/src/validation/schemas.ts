// @ts-nocheck
// Large schema aggregation file; nocheck reduces compiler load. Re-enable selectively later.
import { z } from 'zod';
...
export const ConnectionProviderEnum = z.enum(['notion', 'google-drive', 'onedrive']);
